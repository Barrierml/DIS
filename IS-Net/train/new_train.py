...
def training_loop(opt):
    ...
    u_net = ISNetDIS(in_ch=3, out_ch=4)
    ...
    optimizer = optim.Adam(
        u_net.parameters(), lr=0.0001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0
    )
    
    # optimizer = Lion(u_net.parameters(), lr=1e-4, weight_decay=0)
