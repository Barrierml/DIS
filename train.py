...
base_dir = '/Users/hashiro/Downloads/data/treasures/'

# 定义训练集
train_dataset = DepthDataset(depth_dir=base_dir + 'meitu2/depth', gt_dir=base_dir + 'meitu2/gt', depth_transform=depth_transform, gt_transform=gt_transform)
